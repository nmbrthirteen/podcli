...
// probe, read, or re-encode any file the server user can reach.
function resolveAllowedSource(p: unknown): string | null {
  ...
  return allowedSourcePaths.has(real) ? real : null;
}

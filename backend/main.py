...
def handle_create_clip(task_id: str, params: dict):
    ...
    result = generate_clip(
        ...
        logo_path=asset_store.resolve_logo(params.get("logo_path")),
        outro_path=asset_store.resolve_outro(params.get("outro_path")),
        intro_path=asset_store.resolve_intro(params.get("intro_path")),
    ...
    for i, clip in enumerate(clips):
        ...
        try:
            result = generate_clip(
                ...
                output_dir=params.get("output_dir"),
                logo_path=asset_store.resolve_logo(clip.get("logo_path") or params.get("logo_path")),
                outro_path=asset_store.resolve_outro(params.get("outro_path")),
                intro_path=asset_store.resolve_intro(clip.get("intro_path") or params.get("intro_path")),
                clean_fillers=params.get("clean_fillers", True),
                face_map=params.get("face_map"),
